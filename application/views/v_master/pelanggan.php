<main class="content" style="padding: 10px;">
    ...
    <h1 class="h3 mb-2 ml-3">Data Pelanggan</h1>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body" style="padding: 15px;">
                    ...
                    <button class="btn btn-sm btn-success mb-3" data-toggle="modal" data-target="#modal-tambah-pelanggan">Tambah Pelanggan</button>
...
<!-- Modal add pelanggan -->
<div class="modal fade" id="modal-tambah-pelanggan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="needs-validation" novalidate autocomplete="off" id="form_tambah" method="POST" action="<?= base_url() ?>pelanggan/add_pelanggan_aksi">
                    ...
                    <div class="form-group row mb-3">
                        <label class="col-sm-3 col-form-label">Alamat Pelanggan</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control form-control-lg" id="alamat" name="alamat" required>
                            <div class="invalid-feedback">Alamat Pelanggan harus diisi.</div>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-sm-3 col-form-label">No Telp Pelanggan</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control form-control-lg" id="no_telp" name="no_telp" required>
                            <div class="invalid-feedback">No Telp Pelanggan harus diisi.</div>
                        </div>
                    </div>
...
<div class="modal fade" id="modal-edit-pelanggan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form class="needs-validation" novalidate autocomplete="off" id="form_edit" method="POST" action="<?= base_url() ?>pelanggan/edit_pelanggan_aksi">
...
<script>
    ...
    function edit(id) {
        $.ajax({
            type: "GET",
            url: "<?= base_url() ?>pelanggan/getPelangganById/" + id,
            dataType: 'JSON',
            success: function(response) {
                ...
                $('#modal-edit-pelanggan').modal('toggle');
            }
        })
    }
    // EDIT DATA ----------------------------------------------------------------------------------- EDIT DATA
